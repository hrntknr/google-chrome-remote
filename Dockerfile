...
RUN wget https://github.com/wendigo/chrome-protocol-proxy/releases/download/v${PROXY_VERSION}/chrome-protocol-proxy_${PROXY_VERSION}_linux_x86_64.tar.gz -O /tmp/chrome-protocol-proxy.tar.gz && \
...
RUN wget ${CHROME_URL} -O /tmp/chrome.zip && \
